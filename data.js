...
// مثال لقالب في ملف data.js
  {
    ...
    "content": `
      ...
      رقم تسجيلكم:{{demande}}</div>
      <div class="letter-objet"> الموضوع: {{objet}}</div><div class="letter-body"> جوابا على رسالتكم المشار إلى مرجعها اعلاه، نخبركم أن الفاتورة موضوع شكايتكم تتعلق باستهلاك غير قانوني، وأنها أعدت وفقا لمقتضيات دفتر التحملات للتدبير المفوض للتطهير السائل و توزيع الماء والكهرباء بولاية طنجة.</div><div class="letter-foter"> وتبقى المصالح المختصة لشركة أمانديس رهن إشارتكم من أجل مزيد من التنسيق والتعاون.
      وتقبلوا سيدي فائق التقدير والاحترام.</div><div class="letter-footer">مديرية حماية المبيعات</div>
          `
  },

  {
    ...
    "content": `
        ...
        مرجعكم رسالتكم بتاريخ:{{date}}
        رقم تسجيلكم:{{demande}}</div>
       <div class="letter-objet"> الموضوع: {{objet}}</div><div class="letter-body">جوابا على رسالتكم المشار إلى مرجعها أعلاه، نخبركم أن شركة أمانديس بناء على المعطيات الجديدة المدلى بها من طرفكم سنقوم بدراسة إمكانية إعادة النظر في طلبكم، وإنها ستقوم باتخاذ الإجراءات وفقا لمقتضيات دفتر التحملات للتدبير المفوض للتطهير السائل وتوزيع الماء والكهرباء بولاية طنجة</div><div class="letter-foter">وتبقى المصالح المختصة لشركة أمانديس رهن إشارتكم من أجل مزيد من التنسيق والتعاون.
  ...
  },
  {
    ...
    "content": `
       ...
       <div class="letter-objet"> الموضوع: {{objet}}</div>
       <div class="letter-body"> جوابا على رسالتكم المشار إلى مرجعها أعلاه، نخبركم أن الفاتورة موضوع شكايتكم تتعلق بتسوية وضعية استهلاك غير مفوتر، وأنها أعدت وفقا لمقتضيات دفتر التحملات للتدبير المفوض للتطهير السائل وتوزيع الماء والكهرباء بولاية طنجة.</div><div class="letter-foter"> وتبقى المصالح المختصة لشركة أمانديس رهن إشارتكم من أجل مزيد من التنسيق والتعاون.</div>وتقبلوا سيدي فائق التقدير والاحترام.</div><div class="letter-footer">
         مديرية حماية المبيعات</div>
    `
  },

  {
    ...
    "content": `
        ...
        رقم تسجيلكم:{{demande}}</div><div class="letter-body">
       <div class="letter-objet"> الموضوع: {{objet}}</div>
       <div class="letter-body"> جوابا على رسالتكم المشار إلى مرجعها أعلاه، نخبركم أن شركة أمانديس انتقلت إلى عين المكان وقامت بفحص المنشآت موضوع الشكاية، فلم تتم ملاحظة وجود استهلاك غير قانوني في تلك اللحظة، هذا وستظل هذه الحالة تحت المراقبة</div><div class="letter-foter">.وتقبلوا سيدي فائق التقدير والاحترام</div><div class="letter-footer">
         مديرية حماية المبيعات</div>
    `
  },

  {
    ...
    "content": `
        ...
        مرجعنا: {{demande}} / س ب  
        مرجعكم رسالتكم بتاريخ:{{date}}
        رقم تسجيلكم:{{demande}}</div><div class="letter-objet">
        الموضوع: {{objet}}</div>
        <div class="letter-body">جوابا على رسالتكم المشار إلى مرجعها أعلاه، نخبركم أن الفاتورة موضوع شكايتكم تتعلق باستهلاك غير قانوني ، وأنها أعدت وفقا لمقتضيات دفتر التحملات للتدبير المفوض للتطهير السائل وتوزيع الماء والكهرباء بولاية طنجة.
        ونخبركم بأننا قمنا بمحاولة الاتصال بكم، ولكن لم نتلق أي رد منكم لذا لا يمكن مراجعة أو إلغاء الفاتورة.</div><div class="letter-foter"> وتبقى المصالح المختصة لشركة أمانديس رهن إشارتكم من أجل مزيد من التنسيق والتعاون.
        وتقبلوا سيدي فائق التقدير والاحترام.</div><div class="letter-footer">
         مديرية حماية المبيعات</div>
    `
  },

  {
    ...
    "content": `
        ...
        مرجعكم رسالتكم بتاريخ:{{date}}
        رقم تسجيلكم:{{demande}}</div><div class="letter-objet">
        الموضوع: {{objet}}</div><div class="letter-body">جوابا على رسالتكم المشار إلى مرجعها أعلاه، نخبركم أن الفاتورة موضوع شكايتكم تتعلق باستهلاك غير قانوني ، وأنها أعدت وفقا لمقتضيات دفتر التحملات للتدبير المفوض للتطهير السائل وتوزيع الماء والكهرباء بولاية طنجة.
        و نطلب منكم التوجه الى وكالة أمانديس الأقرب لكم لتقديم الوثائق الاثباثية الأصلية للمصادقة عليها قصد إعادة دراسة الملف وفقا للمساطر المعتمدة لدى الشركة.</div><div class="letter-foter"> وتبقى المصالح المختصة لشركة أمانديس رهن إشارتكم من أجل مزيد من التنسيق والتعاون.
        وتقبلوا سيدي فائق التقدير والاحترام.</div><div class="letter-footer">مديرية حماية المبيعات</div>
    `
  },

  {
    ...
    "content": `
       ...
       <div class="letter-objet"> الموضوع: {{objet}}</div>
       <div class="letter-body"> جوابا على رسالتكم المشار إلى مرجعها أعلاه، نخبركم أن الفاتورة موضوع شكايتكم تتعلق باستهلاك غير قانوني ، وأنها أعدت وفقا لمقتضيات دفتر التحملات للتدبير المفوض للتطهير السائل وتوزيع الماء والكهرباء بولاية طنجة.
       ونخبركم أنه نظرا لغياب الوثائق الإثباتية لا يمكن مراجعة أو إلغاء الفاتورة.</div><div class="letter-foter">وتبقى المصالح المختصة لشركة أمانديس رهن إشارتكم من أجل مزيد من التنسيق والتعاون.</div>وتقبلوا سيدي فائق التقدير والاحترام.<div class="letter-footer">مديرية حماية المبيعات</div>
    `
  },

  {
    ...
    "content": `
        ...
        مرجعكم رسالتكم بتاريخ:{{date}}
        رقم تسجيلكم:{{demande}}</div><div class="letter-objet">
        الموضوع: {{objet}}<div class="letter-body">جوابا على رسالتكم المشار إلى مرجعها أعلا الواردة علينا بتاريخ {{date}} ، بشرفنا إخباركم أنه تعذر علينا القيام بعمليات الفحص اللازمة نظرا لتواجد المنشآت الكهربائية بما فيها مكان العداد داخل محل مغلق بقفل خاص.
        و عليه نطلب منكم رفع هذه الحواجز والمعيقات قصد القيام بالمتعين.</div><div class="letter-foter">وتبقى المصالح المختصة لشركة أمانديس رهن إشارتكم من أجل مزيد من التنسيق والتعاون.
        وتقبلوا سيدي فائق التقدير والاحترام.</div><div class="letter-footer">مديرية حماية المبيعات</div>
    `
  },

  {
    ...
    "content": `
        ...
        رقم تسجيلكم:{{demande}}</div><div class="letter-objet">
        الموضوع: {{objet}}</div><div class="letter-body">جوابا على رسالتكم المشار إلى مرجعها أعلاه، نخبركم أن الفاتورة موضوع شكايتكم تتعلق باستهلاك غير قانوني ، وأنها أعدت وفقا لمقتضيات دفتر التحملات للتدبير المفوض للتطهير السائل وتوزيع الماء والكهرباء بولاية طنجة 
        ونخبركم أن الوثائق المدلى بها يستحيل قراءتها، لذا لا يمكن مراجعة أو إلغاء الفاتورة.</div><div class="letter-foter">وتبقى المصالح المختصة لشركة أمانديس رهن إشارتكم من أجل مزيد من التنسيق والتعاون.
        وتقبلوا سيدي فائق التقدير والاحترام.</div><div class="letter-footer">مديرية حماية المبيعات</div>
    `
  },

  {
    ...
    "content": `
        ...
        مرجعكم رسالتكم بتاريخ:{{date}}
        رقم تسجيلكم:{{demande}}</div><div class="letter-objet">
        الموضوع: {{objet}}</div><div class="letter-body">جوابا على رسالتكم المشار إلى مرجعها أعلاه، نخبركم اننا توصلنا بطلبكم، وهو الآن قيد الدراسة أخذا بعين الاعتبار كافة التفاصيل و الاثباتات المدلى بها. 
        في حال وجود أي استفسارات إضافية، لا تترددوا في التواصل معنا
        </div><div class="letter-foter">وتبقى المصالح المختصة لشركة أمانديس رهن إشارتكم من أجل مزيد من التنسيق والتعاون.
        وتقبلوا سيدي فائق التقدير والاحترام.</div><div class="letter-footer">مديرية حماية المبيعات</div>
    `
  },

  {
    ...
    "content": `
        ...
        مرجعكم رسالتكم بتاريخ:{{date}}
        رقم تسجيلكم:{{demande}}</div><div class="letter-objet">
        الموضوع: {{objet}}</div><div class="letter-body">جوابا على رسالتكم المشار إلى مرجعها أعلاه، وتبعا للمراقبة المنجزة من طرف عون أمانديس بحضوركم نخبركم انه قد تبين وجود استهلاك غير قانوني. و عليه فإن الفاتورة موضوع شكايتكم المتعلقة بالاستهلاك غير القانوني أعدت وفقا لمقتضيات دفتر التحملات للتدبير المفوض للتطهير السائل وتوزيع الماء والكهرباء بولاية طنجة
        </div><div class="letter-foter">وتبقى المصالح المختصة لشركة أمانديس رهن إشارتكم من أجل مزيد من التنسيق والتعاون.
        وتقبلوا سيدي فائق التقدير والاحترام.</div><div class="letter-footer">مديرية حماية المبيعات</div>
    `
  },

  {
    ...
    "content": `
        ...
        رقم تسجيلكم:{{demande}}</div><div class="letter-objet">
        الموضوع: {{objet}}</div><div class="letter-body">جوابا على رسالتكم المشار إلى مرجعها أعلاه، نخبركم أن الفاتورة موضوع شكايتكم تتعلق باستهلاك غير قانوني ، وأنها أعدت وفقا لمقتضيات دفتر التحملات للتدبير المفوض للتطهير السائل وتوزيع الماء والكهرباء بولاية طنجة.
        ونخبركم بأنه نظرًا لعدم توفر الوثائق الإثباتية بشكل كافٍ، لا يمكن مراجعة أو إلغاء الفاتورة.</div><div class="letter-foter">تبقى المصالح المختصة لشركة أمانديس رهن إشارتكم من أجل مزيد من التنسيق والتعاون.
        وتقبلوا سيدي فائق التقدير والاحترام.</div><div class="letter-footer">مديرية حماية المبيعات</div>
    `
  },

  {
    ...
    "content": `
        ...
        مرجعكم رسالتكم بتاريخ:{{date}}
        رقم تسجيلكم:{{demande}}</div><div class="letter-objet">
        الموضوع: {{objet}}</div><div class="letter-body">جوابا على رسالتكم المشار إلى مرجعها أعلاه، نحيطكم علمًا بأننا قد تلقينا شكايتكم وبأنها حظيت بكل العناية والاهتمام اللازمين.
