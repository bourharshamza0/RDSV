...
// مثال لقالب في ملف data.js
  {
    ...
    "content": `
        ...
        منسقة مديرية حماية المبيعات</div>
    `
  },
...

  {
    ...
    "content": `
        ...
        رقم تسجيلكم:{{demande}}</div><div class="letter-body">
        الموضوع: {{objet}}
        جوابا على رسالتكم المشار إلى مرجعها أعلاه، نخبركم أن شكايتكم قد حظيت كل العناية والاهتمام اللازمين و أن ملفكم  قيد الدراسة من طرف المصالح المختصة، وسيتم التعامل معها وفقا لمقتضيات دفتر التحملات لعقد التدبير المفوض لمرافق 
        التطهير السائل وتوزيع الماء والكهرباء بولاية طنجة.
        
        كما نحيطكم أنه، إذا اقتضى الأمر، فإن المصالح المختصة لشركة أمانديس قد تربط الاتصال المباشر بكم
